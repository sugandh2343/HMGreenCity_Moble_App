...
import com.hmgreencity.model.response.responsePayoutReportSearch.LstPayoutDetail;
...
public class PayoutReportSearchAdapter extends RecyclerView.Adapter<PayoutReportSearchAdapter.ViewHolder> {
    private List<LstPayoutDetail> models;
    private Context context;

    public PayoutReportSearchAdapter(List<LstPayoutDetail> models, Context context) {
        this.models = models;
        this.context = context;
    }

    @Override
    public PayoutReportSearchAdapter.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.payout_report_item, viewGroup, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(PayoutReportSearchAdapter.ViewHolder viewHolder, int i) {
        ...
        viewHolder.tvProcessingFee.setText(models.get(i).getBinaryIncome());
