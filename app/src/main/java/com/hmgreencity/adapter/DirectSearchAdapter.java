...
import com.hmgreencity.model.response.responseDirectSearch.responseLstdirect;
...
public class DirectSearchAdapter extends RecyclerView.Adapter<DirectSearchAdapter.ViewHolder> {
    private List<responseLstdirect> models;
    private Context context;

    public DirectSearchAdapter(List<responseLstdirect> models, Context context) {
        this.models = models;
        this.context = context;
    }

    @Override
    public DirectSearchAdapter.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.adapter_direct, viewGroup, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(DirectSearchAdapter.ViewHolder viewHolder, int i) {

        viewHolder.tvLoginId.setText(models.get(i).getSponsorId());
        viewHolder.tvName.setText(models.get(i).getSponsorName());
        viewHolder.tvPackage.setText(models.get(i).get_package());
